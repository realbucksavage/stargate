...
// Middleware receives a http.Handler and returns a http.HandlerFunc. The returned http.HandlerFunc is a closure that
...
func createHandler(lb LoadBalancer, mwf []Middleware) http.HandlerFunc {
